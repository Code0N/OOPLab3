========================================================================
    КОНСОЛЬНОЕ ПРИЛОЖЕНИЕ. Обзор проекта Memories from a Distant Past
========================================================================

Это приложение Memories from a Distant Past создано автоматически с помощью мастера 
приложений.

Здесь приведены краткие сведения о содержимом каждого из файлов, использованных 
при создании приложения Memories from a Distant Past.


Memories from a Distant Past.vcxproj
...
Memories from a Distant Past.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) с именем Memories from a Distant Past.pch и файла предкомпилированных типов 
    с именем StdAfx.obj.
